						...
						$.ajax({
									...
									success : function(data) {
										...
										$.each(dataObj.managedList,
														function(i, buginfo) {
															var record = [];
															record.push("<img src='assets/datatables/images/details_open.png' >");
						...
						var nTr = $(this).parents('tr')[0];
					  	var id = nTr.childNodes[index].childNodes[0].attributes['data-id'].value;
							...
							if ( ownerBugDataTable.fnIsOpen(nTr) )
							{
								...
								this.src = "assets/datatables/images/details_open.png";
								ownerBugDataTable.fnClose( nTr );
							}
							else
							{
								//Open this row
								this.src = "assets/datatables/images/details_close.png";
								$.ajax({
									type: "get",
