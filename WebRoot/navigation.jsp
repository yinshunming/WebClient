	...
	<div class="container">
		...
		<div class="collapse navbar-collapse">
			<ul class="nav navbar-nav">
				<li id="mainFrameJSPNav"><a href="mainFrame">DashBoard</a></li>
				<!-- <li id="addBugJSPNav"><a href="addBug.jsp">Add Bug</a></li> -->
				<li id="historyBugsJSPNav"><a href="historyBugs">Histroy
						Bugs</a></li>
			</ul>

			<ul class="nav navbar-nav navbar-right">
				<li id="feedbackNav"><a href='http://10.158.2.124:8050/feedback/' >Feedback</a></li>
				<li id="registerJSPNav"><a href="register">Register</a></li>
